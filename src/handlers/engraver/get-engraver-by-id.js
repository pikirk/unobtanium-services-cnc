...
exports.getEngraverById = void 0;
...
var getEngraverById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var engraver;
    return __generator(this, function (_a) {
        try {
            ...
            engraver = mockEngravers.find(function (e) { return e.id === id; });
            if (!engraver) {
                return [2 /*return*/, {
                        data: { error: "Engraver with ID ".concat(id, " not found") },
                        statusCode: 404
                    }];
            }
            return [2 /*return*/, {
...
exports.getEngraverById = getEngraverById;
